...
(* OASIS_START *)
(* DO NOT EDIT (digest: 437d2e4cd751fd753d6c1174eac3b350) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "uucdCompiler.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.3");
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "·#v|g \145\003¿MÌæ¨\155*Z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
